...
const recipeSchema = z.object({
  ...
  missingIngredients: z.array(z.string()).describe("List of missing ingredients."),
  ...
  try {
    ...
    const response = await openai.responses.parse({
      ...
      input: [
        {
          role: "system",
          content: "You are a experienced cook. Your job is to help customer prepare their meals based on their needs.",
        },
        {
          role: "user",
          content: prompt,
